...
void queue_base::add(double valuev)
{
	elem* temp = new elem;
	if (k == 0) {
		temp->Val = valuev;
...
queue_base queue_base::sum(queue_base& obj1, queue_base& obj2)
{
...
queue_base queue_base::divide(queue_base& obj, double valuev)
{
	queue_base j;
	elem* temp = obj.get_b();
...
queue_base queue_base::multiplication(queue_base& obj1, queue_base& obj2)
{
	elem* temp = obj1.get_b();
	queue_base j;
	double* och_i = new double[obj1.get_k()];
...
queue_base queue_base::operator+(queue_base& b)
{
	return sum(*this, b);
}

queue_base queue_base::operator-=(int)
{
	if (!(this->get_k())) {
...
queue_base queue_base::operator/(double valuev)
{
